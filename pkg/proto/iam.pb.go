...
const file_proto_iam_proto_rawDesc = "" +
	...
	"\x0fassumed_role_id\x18\x02 \x01(\tR\rassumedRoleId2\x94\x0e\n" +
	"\x03IAM\x127\n" +
	"\n" +
	...
	"\x0fCheckPermission\x12\x1e.iam.v1.CheckPermissionRequest\x1a\x1f.iam.v1.CheckPermissionResponse\"\x00\x12E\n" +
	"\n" +
	"AssumeRole\x12\x19.iam.v1.AssumeRoleRequest\x1a\x1a.iam.v1.AssumeRoleResponse\"\x00\x12T\n" +
	"\x0fGetSessionToken\x12\x1e.iam.v1.GetSessionTokenRequest\x1a\x1f.iam.v1.GetSessionTokenResponse\"\x00\x12K\n" +
	"\fRefreshToken\x12\x1b.iam.v1.RefreshTokenRequest\x1a\x1c.iam.v1.RefreshTokenResponse\"\x00\x12H\n" +
	"\vRevokeToken\x12\x1a.iam.v1.RevokeTokenRequest\x1a\x1b.iam.v1.RevokeTokenResponse\"\x00B3Z1github.com/vera-byte/vgo-iam/internal/proto;iamv1b\x06proto3"
...
var file_proto_iam_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_proto_iam_proto_goTypes = []any{
	...
	(*AssumeRoleRequest)(nil),                  // 30: iam.v1.AssumeRoleRequest
	(*AssumeRoleResponse)(nil),                 // 31: iam.v1.AssumeRoleResponse
	(*GetSessionTokenRequest)(nil),             // 32: iam.v1.GetSessionTokenRequest
	(*GetSessionTokenResponse)(nil),            // 33: iam.v1.GetSessionTokenResponse
	(*RefreshTokenRequest)(nil),                // 34: iam.v1.RefreshTokenRequest
	(*RefreshTokenResponse)(nil),               // 35: iam.v1.RefreshTokenResponse
	(*RevokeTokenRequest)(nil),                 // 36: iam.v1.RevokeTokenRequest
	(*RevokeTokenResponse)(nil),                // 37: iam.v1.RevokeTokenResponse
	(*TemporaryCredentials)(nil),               // 38: iam.v1.TemporaryCredentials
	(*AssumedRoleUser)(nil),                    // 39: iam.v1.AssumedRoleUser
	nil,                                        // 40: iam.v1.AssumeRoleRequest.TagsEntry
	(*timestamppb.Timestamp)(nil),              // 41: google.protobuf.Timestamp
}
var file_proto_iam_proto_depIdxs = []int32{
	41, // 0: iam.v1.User.created_at:type_name -> google.protobuf.Timestamp
	41, // 1: iam.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	41, // 2: iam.v1.Policy.created_at:type_name -> google.protobuf.Timestamp
	41, // 3: iam.v1.Policy.updated_at:type_name -> google.protobuf.Timestamp
	41, // 4: iam.v1.DeveloperVerification.reviewed_at:type_name -> google.protobuf.Timestamp
	41, // 5: iam.v1.DeveloperVerification.created_at:type_name -> google.protobuf.Timestamp
	41, // 6: iam.v1.DeveloperVerification.updated_at:type_name -> google.protobuf.Timestamp
	11, // 7: iam.v1.ListDeveloperVerificationsResponse.verifications:type_name -> iam.v1.DeveloperVerification
	41, // 8: iam.v1.Application.created_at:type_name -> google.protobuf.Timestamp
	41, // 9: iam.v1.Application.updated_at:type_name -> google.protobuf.Timestamp
	19, // 10: iam.v1.ListApplicationsResponse.applications:type_name -> iam.v1.Application
	41, // 11: iam.v1.AccessKey.created_at:type_name -> google.protobuf.Timestamp
	41, // 12: iam.v1.AccessKey.updated_at:type_name -> google.protobuf.Timestamp
	24, // 13: iam.v1.ListAccessKeysResponse.access_keys:type_name -> iam.v1.AccessKey
	40, // 14: iam.v1.AssumeRoleRequest.tags:type_name -> iam.v1.AssumeRoleRequest.TagsEntry
	38, // 15: iam.v1.AssumeRoleResponse.credentials:type_name -> iam.v1.TemporaryCredentials
	39, // 16: iam.v1.AssumeRoleResponse.assumed_role_user:type_name -> iam.v1.AssumedRoleUser
	38, // 17: iam.v1.GetSessionTokenResponse.credentials:type_name -> iam.v1.TemporaryCredentials
	38, // 18: iam.v1.RefreshTokenResponse.credentials:type_name -> iam.v1.TemporaryCredentials
	41, // 19: iam.v1.TemporaryCredentials.expiration:type_name -> google.protobuf.Timestamp
	0,  // 20: iam.v1.IAM.CreateUser:input_type -> iam.v1.CreateUserRequest
	1,  // 21: iam.v1.IAM.GetUser:input_type -> iam.v1.GetUserRequest
	3,  // 22: iam.v1.IAM.CreatePolicy:input_type -> iam.v1.CreatePolicyRequest
	4,  // 23: iam.v1.IAM.AttachUserPolicy:input_type -> iam.v1.AttachUserPolicyRequest
	7,  // 24: iam.v1.IAM.SubmitDeveloperVerification:input_type -> iam.v1.SubmitDeveloperVerificationRequest
	8,  // 25: iam.v1.IAM.GetDeveloperVerification:input_type -> iam.v1.GetDeveloperVerificationRequest
	9,  // 26: iam.v1.IAM.ListDeveloperVerifications:input_type -> iam.v1.ListDeveloperVerificationsRequest
	10, // 27: iam.v1.IAM.ReviewDeveloperVerification:input_type -> iam.v1.ReviewDeveloperVerificationRequest
	13, // 28: iam.v1.IAM.CreateApplication:input_type -> iam.v1.CreateApplicationRequest
	14, // 29: iam.v1.IAM.GetApplication:input_type -> iam.v1.GetApplicationRequest
	15, // 30: iam.v1.IAM.ListApplications:input_type -> iam.v1.ListApplicationsRequest
	16, // 31: iam.v1.IAM.UpdateApplication:input_type -> iam.v1.UpdateApplicationRequest
	17, // 32: iam.v1.IAM.DeleteApplication:input_type -> iam.v1.DeleteApplicationRequest
	21, // 33: iam.v1.IAM.CreateAccessKey:input_type -> iam.v1.CreateAccessKeyRequest
	22, // 34: iam.v1.IAM.ListAccessKeys:input_type -> iam.v1.ListAccessKeysRequest
	23, // 35: iam.v1.IAM.UpdateAccessKeyStatus:input_type -> iam.v1.UpdateAccessKeyStatusRequest
	26, // 36: iam.v1.IAM.VerifyAccessKey:input_type -> iam.v1.VerifyRequest
	28, // 37: iam.v1.IAM.CheckPermission:input_type -> iam.v1.CheckPermissionRequest
	30, // 38: iam.v1.IAM.AssumeRole:input_type -> iam.v1.AssumeRoleRequest
	32, // 39: iam.v1.IAM.GetSessionToken:input_type -> iam.v1.GetSessionTokenRequest
	34, // 40: iam.v1.IAM.RefreshToken:input_type -> iam.v1.RefreshTokenRequest
	36, // 41: iam.v1.IAM.RevokeToken:input_type -> iam.v1.RevokeTokenRequest
	2,  // 42: iam.v1.IAM.CreateUser:output_type -> iam.v1.User
	2,  // 43: iam.v1.IAM.GetUser:output_type -> iam.v1.User
	6,  // 44: iam.v1.IAM.CreatePolicy:output_type -> iam.v1.Policy
	5,  // 45: iam.v1.IAM.AttachUserPolicy:output_type -> iam.v1.AttachUserPolicyResponse
	11, // 46: iam.v1.IAM.SubmitDeveloperVerification:output_type -> iam.v1.DeveloperVerification
	11, // 47: iam.v1.IAM.GetDeveloperVerification:output_type -> iam.v1.DeveloperVerification
	12, // 48: iam.v1.IAM.ListDeveloperVerifications:output_type -> iam.v1.ListDeveloperVerificationsResponse
	11, // 49: iam.v1.IAM.ReviewDeveloperVerification:output_type -> iam.v1.DeveloperVerification
	19, // 50: iam.v1.IAM.CreateApplication:output_type -> iam.v1.Application
	19, // 51: iam.v1.IAM.GetApplication:output_type -> iam.v1.Application
	20, // 52: iam.v1.IAM.ListApplications:output_type -> iam.v1.ListApplicationsResponse
	19, // 53: iam.v1.IAM.UpdateApplication:output_type -> iam.v1.Application
	18, // 54: iam.v1.IAM.DeleteApplication:output_type -> iam.v1.DeleteApplicationResponse
	24, // 55: iam.v1.IAM.CreateAccessKey:output_type -> iam.v1.AccessKey
	25, // 56: iam.v1.IAM.ListAccessKeys:output_type -> iam.v1.ListAccessKeysResponse
	24, // 57: iam.v1.IAM.UpdateAccessKeyStatus:output_type -> iam.v1.AccessKey
	27, // 58: iam.v1.IAM.VerifyAccessKey:output_type -> iam.v1.VerifyResponse
	29, // 59: iam.v1.IAM.CheckPermission:output_type -> iam.v1.CheckPermissionResponse
	31, // 60: iam.v1.IAM.AssumeRole:output_type -> iam.v1.AssumeRoleResponse
	33, // 61: iam.v1.IAM.GetSessionToken:output_type -> iam.v1.GetSessionTokenResponse
	35, // 62: iam.v1.IAM.RefreshToken:output_type -> iam.v1.RefreshTokenResponse
	37, // 63: iam.v1.IAM.RevokeToken:output_type -> iam.v1.RevokeTokenResponse
